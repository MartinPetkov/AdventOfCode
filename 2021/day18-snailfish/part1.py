...
def solve(data):
  ...
  # First parse each line as a tree.
  snail = list_to_snail(eval(lines[0]))
  for line in lines[1:]:
    # I hate to do this, but it's begging for it, the input is practically a
    # Python list already.
    snail += list_to_snail(eval(line))
    print(snail)
